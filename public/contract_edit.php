...
// Wichtig: Upload-Logik in dieser Datei ausschließlich über src/upload.php pflegen.
// Keine alten Inline-Upload-Blöcke aus GitHub-Web-Konfliktlösungen einfügen.
require_login();
