...
function db(): mysqli
{
    ...
    $dbHost = getenv('CONTRACTAPP_DB_HOST') ?: '10.100.4.95';
    ...
    if (!is_string($dbPass) || $dbPass === 'jREIOV0jkO6Q5dN23OYV') {
        app_log('config', 'Umgebungsvariable CONTRACTAPP_DB_PASS fehlt.');
